...
- [Rich HTML Rendering Status](docs/rich-html-rendering-status.md)
...
- `docs`：架构文档、渲染计划、测试 runbook 和第三方声明。
...
真机和模拟器验证可参考 `docs/` 下的 Android 测试 runbook。
...
- `docs`: Architecture notes, renderer plans, testing runbooks, and third-party notices.
...
For device-level validation, use the Android testing runbooks under `docs/`.
